...
?>
    ...
    <button value="Continue" class='btn btn-light' type="submit" name="continue">Continue</button>
 <button class='btn btn-light' type="submit" name="update">Update</button>
<button name='checkout' type="submit" class='btn btn-light'>Check Out</button>
